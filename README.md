...
Linux: [![Circle CI](https://circleci.com/gh/conda-forge/jaraco.logging-feedstock.svg?style=shield)](https://circleci.com/gh/conda-forge/jaraco.logging-feedstock)
OSX: [![TravisCI](https://travis-ci.org/conda-forge/jaraco.logging-feedstock.svg?branch=master)](https://travis-ci.org/conda-forge/jaraco.logging-feedstock)
Windows: [![AppVeyor](https://ci.appveyor.com/api/projects/status/github/conda-forge/jaraco.logging-feedstock?svg=True)](https://ci.appveyor.com/project/conda-forge/jaraco-logging-feedstock/branch/master)
...
Once the `conda-forge` channel has been enabled, `jaraco.logging` can be installed with:

```
conda install jaraco.logging
```

It is possible to list all of the versions of `jaraco.logging` available on your platform with:
